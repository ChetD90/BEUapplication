...
namespace BEUapplication.App_Code {
    ...
    public partial class dsUser : global::System.Data.DataSet {
        ...
        public partial class adminDataTable : global::System.Data.TypedTableBase<adminRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public adminRow AddadminRow(string username, string password, string SecurityLevel) {
            ...
            private void InitClass() {
                ...
                this.columnSecurityLevel.MaxLength = 255;
            }
        ...
        public partial class adminRow : global::System.Data.DataRow {
            ...
            public string SecurityLevel {
                get {
                    try {
                        return ((string)(this[this.tableadmin.SecurityLevelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'SecurityLevel\' in table \'admin\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableadmin.SecurityLevelColumn] = value;
                }
            }
            ...
            public bool IsSecurityLevelNull() {
                return this.IsNull(this.tableadmin.SecurityLevelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetSecurityLevelNull() {
                this[this.tableadmin.SecurityLevelColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace BEUapplication.App_Code.dsUserTableAdapters {
    ...
    public partial class adminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `admin` WHERE ((`adminID` = ?))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `admin` (`username`, `password`, `SecurityLevel`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `admin` SET `username` = ?, `password` = ?, `SecurityLevel` = ? WHERE ((`a" +
                "dminID` = ?))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT adminID, username, [password], SecurityLevel FROM admin";
        ...
        public virtual int Fill(dsUser.adminDataTable dataTable) {
        ...
        public virtual dsUser.adminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsUser.adminDataTable dataTable = new dsUser.adminDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsUser.adminDataTable dataTable) {
        ...
        public virtual int Insert(string username, string password, string SecurityLevel) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string SecurityLevel, int Original_adminID) {
            if ((username == null)) {
